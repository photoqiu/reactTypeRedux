...
const webpackConfigBase = {
    ...
    context: __dirname,
    resolve: {  
        extensions: ['*', '.less', '.css', '.js', '.jsx', '.tsx', '.ts', '.json'],
        alias: { // 减少使用别名提高编译速速
    ...
    plugins: [
        ...
        new HappyPack({
            id: 'happyBabel',
            loaders: ['source-map-loader', 'babel-loader?cacheDirectory=true'],
            threadPool: happyThreadPool,
            verbose: false
        }),
        new HappyPack({
            id: 'happyTSBabel',
            loaders: ['source-map-loader', 'babel-loader?cacheDirectory=true', 'awesome-typescript-loader'],
            threadPool: happyThreadPool,
            verbose: false
        }),
        new HappyPack({
